        ...
        <div class="row p-3">
            ...
            <div class="card">
                <div class="card-header">
                    <h1 style="position:absolute;">Crear Categoría</h1>
                    <a class="btn btn-primary float-end" href="/categoria" style="width:100px;">Volver</a>
                </div>
                <div class="card-body p-3">
                    <form action="https://repositorio.itsup.edu.ec/categoria/almacenar" method="post" enctype="multipart/form-data" autocomplete="off">
                        <div class="mb-3">
