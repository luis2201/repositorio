        ...
        <div class="page-breadcrumb">
          <div class="row">
            <div class="col-12 d-flex no-block align-items-center">
              <h4 class="page-title">Listado de Documentos por Áreas</h4>
        ...
        <div class="row p-3">
            ...
            <div class="card">
                <div class="card-header">
                    <h1 style="position:absolute;"><?php echo $this->area->Nombre; ?></h1> 
                    <a class="btn btn-primary float-end" href="/listadocumentoarea" style="width:100px;">Volver</a>
                </div>
