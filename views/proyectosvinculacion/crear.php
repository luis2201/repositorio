        ...
        <div class="row p-3">
            ...
            <div class="card">
                <div class="card-header">
                    <h1 style="position:absolute;">Registrar Proyecto</h1>
                    <a class="btn btn-primary float-end" href="/proyectosvinculacion" style="width:100px;">Volver</a>
                </div>
                <div class="card-body p-3">            
                    <form action="https://repositorio.itsup.edu.ec/proyectosvinculacion/almacenar" method="post" enctype="multipart/form-data" autocomplete="off">
                        <input type="hidden" id="TipoProyecto" name="TipoProyecto" value="V">
                        <div class="row">
                            <div class="mb-3">
