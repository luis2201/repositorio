                ...
                <nav aria-label="breadcrumb">
                  <ol class="breadcrumb">
                    ...
                    <li class="breadcrumb-item active" aria-current="page">
                      Lista de Documentos por Materia
                    </li>
                  </ol>
                </nav>
              </div>
        ...
        <div class="row p-3">
            ...
            <div class="card">
                <div class="card-header">
                    <h1 style="position:absolute;">Listado de Documentos por Materias</h1> 
                </div>
                          ...
                          <tbody>
                              ...
                              <tr>
                                  ...
                                  <td class="text-center">
                                      <a class="text-success" href="listadocumentomateria/leerDocumentoIDMateria/<?php echo $row['MateriaID']; ?>"><i class="fas fa-search"></i></a>
                                  </td>
                              </tr>
                              <?php endwhile; ?>
                          </tbody>
