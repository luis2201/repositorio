        ...
        <div class="page-breadcrumb">
          <div class="row">
            <div class="col-12 d-flex no-block align-items-center">
              <h4 class="page-title">Listado de Documentos por Materias</h4>
        ...
        <div class="row p-3">
            ...
            <div class="card">
                <div class="card-header">
                    <h1 style="position:absolute;"><?php echo $this->materia->Nombre; ?></h1> 
                    <a class="btn btn-primary float-end" href="/listadocumentocategoria" style="width:100px;">Volver</a>
                </div>
                            ...
                            <?php while ($row = $stmt->fetch(PDO::FETCH_ASSOC)): ?>
                              <tr>
                                  ...
                                  <td class="text-center">
                                      <a class="text-success" href="<?php echo DIR; ?>listadocumentocategoria/ver/<?php echo $row['ArchivoPDF']; ?>" target="_blank"><i class="fas fa-book"></i></a>
                                  </td>
                              </tr>
                              <?php endwhile; ?>
                          </tbody>
