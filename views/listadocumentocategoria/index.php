        ...
        <div class="row p-3">
            ...
            <div class="card">
                <div class="card-header">
                    <h1 style="position:absolute;">Listado de Documentos por Categorías</h1> 
                </div>
                    ...
                    <tbody>
                        ...
                        <tr>
                            ...
                            <td class="text-center">
                                <a class="text-success" href="listadocumentocategoria/leerDocumentoIDCategoria/<?php echo $row['CategoriaID']; ?>"><i class="fas fa-search"></i></a>
                            </td>
                        </tr>
                        <?php endwhile; ?>
                    </tbody>
