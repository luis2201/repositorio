        ...
        <div class="row p-3">
            ...
            <div class="card">
                <div class="card-header">
                    <h1 style="position:absolute;">Registrar Patente</h1>
                    <a class="btn btn-primary float-end" href="/patentes" style="width:100px;">Volver</a>
                </div>
                <div class="card-body p-3">            
                    <form action="https://repositorio.itsup.edu.ec/patentes/almacenar" method="post" enctype="multipart/form-data" autocomplete="off">
                        <input type="hidden" id="TipoProyecto" name="TipoProyecto" value="P">
                        <div class="row">
                            <div class="mb-3">
                        ...
                        <div class="row">
                            <div class="col mb-3">
                                ...
                                <input type="date" name="FechaAprobacion" id="FechaAprobacion" class="form-control" required>
                            </div>                  
                        </div>  
                        <div class="row">
                            <div class="col-6 mb-3">
                                <label class="form-label" for="AutorDocente">Autor(es) Docente(s):</label>
                                <input type="text" name="AutorDocente" id="AutorDocente" class="form-control" required>
                            </div>
                            <div class="col-6 mb-3">
                                <label class="form-label" for="AutorEstudiante">Autor(es) Estudiante(s):</label>
                                <input type="text" name="AutorEstudiante" id="AutorEstudiante" class="form-control" required>
                            </div>
                        </div>
                        <div class="row">
                            <div class="mb-3">
